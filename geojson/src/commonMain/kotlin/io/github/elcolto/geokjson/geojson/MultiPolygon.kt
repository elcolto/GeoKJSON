...
foreignMembers: Map<String, Any> = emptyMap()
    ...
    override fun json(): String = """{"type":"MultiPolygon",${bbox.jsonProp()}"coordinates":${coordinates.jsonJoin { polygon -> polygon.jsonJoin { it.jsonJoin(transform = Position::json) } }}${serializeForeignMembers()}}"""
